...
<?php if (\App\Core\App::isLogged()): ?>
    ...
    <form method="POST" action="/addContact">
        <td align="right"><br><b>Nazwa firmy: </b> </td><td align="left"><input name="companyname"></td>
        <td align="right"><br><b>Imie i nazwisko: </b> </td><td align="left"><input name="username" </td>
        <td align="right"><br><b>Stanowisko: </b> </td><td align="left"><input name="position" </td>
        <td align="right"><br><b>Telefon: </b> </td><td align="left"><input name="phonenumber" </td>
        <td align="right"><br><b>E-mail: </b> </td><td align="left"><input name="email" type="email" </td>
        <td align="right"><br><b>Własciciel </b> </td><td align="left"><input name="ownerid" type="number" </td>
